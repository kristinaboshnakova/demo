...
/* =========================================================
  ...
  function showMfgSlide(i) {
    mfgSlides.forEach(s => s.classList.remove("active"));
    mfgSlides[i].classList.add("active");
  }
  
  nextBtn.addEventListener("click", () => {
    mfgIndex = (mfgIndex + 1) % mfgSlides.length;
    showMfgSlide(mfgIndex);
  });
  
  prevBtn.addEventListener("click", () => {
    mfgIndex = (mfgIndex - 1 + mfgSlides.length) % mfgSlides.length;
    showMfgSlide(mfgIndex);
  });
 ...
 function openChristmasPopup() {
  setTimeout(() => {
    document.getElementById("christmasPopup").classList.add("show");
  }, 300);
}

function closeChristmasPopup() {
  document.getElementById("christmasPopup").classList.remove("show");
}

window.addEventListener("load", openChristmasPopup);
